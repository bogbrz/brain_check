...
import 'package:brain_check/data_sources/authentication_data_source.dart'
    as _i4;
import 'package:brain_check/data_sources/duel_game_data_source.dart' as _i6;
import 'package:brain_check/data_sources/questions_data_source.dart' as _i14;
import 'package:brain_check/data_sources/ranking_data_source.dart' as _i8;
import 'package:brain_check/domain/models/amount_button_model.dart' as _i3;
...
import 'package:brain_check/domain/repositories/questions_repository.dart'
    as _i15;
import 'package:brain_check/domain/repositories/ranking_repository.dart' as _i9;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i3.AmountModel>(() => _i3.AmountModel(
          name: gh<String>(),
          nameId: gh<int>(),
          required: gh<dynamic>(),
        ));
    gh.factory<_i4.AuthDataSource>(() => _i4.AuthDataSource());
    gh.factory<_i5.AuthRepository>(
        () => _i5.AuthRepository(authDataSource: gh<_i4.AuthDataSource>()));
    gh.factory<_i6.DuelGameDataSource>(() => _i6.DuelGameDataSource());
    gh.factory<_i7.LogInPageCubit>(
        () => _i7.LogInPageCubit(authRepository: gh<_i5.AuthRepository>()));
    gh.factory<_i8.RankingFireBaseDataSource>(
        () => _i8.RankingFireBaseDataSource());
    gh.factory<_i9.RankingRepository>(() => _i9.RankingRepository(
        rankingFireBaseDataSource: gh<_i8.RankingFireBaseDataSource>()));
    gh.factory<_i10.RootPageCubit>(
        () => _i10.RootPageCubit(authRepository: gh<_i5.AuthRepository>()));
    gh.factory<_i11.SetUpUserCubit>(() =>
        _i11.SetUpUserCubit(rankingRepository: gh<_i9.RankingRepository>()));
    gh.factory<String>(
    ...
    gh.factory<_i12.UserPageCubit>(() => _i12.UserPageCubit(
          ...
          rankingRepository: gh<_i9.RankingRepository>(),
        ));
    ...
    gh.factory<_i17.RankingPageCubit>(() =>
        _i17.RankingPageCubit(rankingRepository: gh<_i9.RankingRepository>()));
    ...
    gh.factory<_i21.DuelGameRepository>(() => _i21.DuelGameRepository(
          duelGameDataSource: gh<_i6.DuelGameDataSource>(),
          questionDataSource: gh<_i14.QuestionDataSource>(),
        ));
