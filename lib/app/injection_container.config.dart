...
import 'package:brain_check/data_sources/questions_data_source.dart' as _i16;
import 'package:brain_check/data_sources/ranking_data_source.dart' as _i9;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i8.LogInPageCubit>(
        () => _i8.LogInPageCubit(authRepository: gh<_i4.AuthRepository>()));
    gh.factory<_i9.RankingFireBaseDataSource>(
        () => _i9.RankingFireBaseDataSource());
    gh.factory<_i10.RankingRepository>(() => _i10.RankingRepository(
        rankingFireBaseDataSource: gh<_i9.RankingFireBaseDataSource>()));
    gh.factory<_i11.ResultPageCubit>(() =>
        _i11.ResultPageCubit(rankingRepository: gh<_i10.RankingRepository>()));
    gh.factory<_i12.RootPageCubit>(
        () => _i12.RootPageCubit(authRepository: gh<_i4.AuthRepository>()));
    gh.factory<_i13.SetUpUserCubit>(() =>
        _i13.SetUpUserCubit(rankingRepository: gh<_i10.RankingRepository>()));
    gh.factory<String>(
      () => registerModule.baseUrl,
      instanceName: 'BaseUrl',
    );
    gh.factory<_i14.UserPageCubit>(() => _i14.UserPageCubit(
          authRepository: gh<_i4.AuthRepository>(),
          rankingRepository: gh<_i10.RankingRepository>(),
        ));
    gh.lazySingleton<_i15.Dio>(
        () => registerModule.dio(gh<String>(instanceName: 'BaseUrl')));
    gh.factory<_i16.QuestionDataSource>(
        () => _i16.QuestionDataSource(gh<_i15.Dio>()));
    gh.factory<_i17.QuestionRepository>(() => _i17.QuestionRepository(
        questionDataSource: gh<_i16.QuestionDataSource>()));
    gh.factory<_i18.QuestionTestPageCubit>(() => _i18.QuestionTestPageCubit(
          questionRepository: gh<_i17.QuestionRepository>(),
          rankingRepository: gh<_i10.RankingRepository>(),
        ));
    gh.factory<_i19.RankedGameCubit>(() =>
        _i19.RankedGameCubit(rankingRepository: gh<_i10.RankingRepository>()));
    gh.factory<_i20.RankingPageCubit>(() =>
        _i20.RankingPageCubit(rankingRepository: gh<_i10.RankingRepository>()));
